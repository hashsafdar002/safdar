...
from docu_chat.open_ai.openai_models import (
    OpenAICompletion,
    OpenAIMessage,
)
from docu_chat.server.chat.chat_router import ChatBody, chat_completion
from docu_chat.server.utils.auth import authenticated
