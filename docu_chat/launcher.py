...
from docu_chat.paths import docs_path
from docu_chat.server.chat.chat_router import chat_router
from docu_chat.server.chunks.chunks_router import chunks_router
from docu_chat.server.completions.completions_router import completions_router
from docu_chat.server.embeddings.embeddings_router import embeddings_router
from docu_chat.server.health.health_router import health_router
from docu_chat.server.ingest.ingest_router import ingest_router
...
def create_app(root_injector: Injector) -> FastAPI:
    ...
    with open(docs_path / "description.md") as description_file:
        ...
        if settings.ui.enabled:
            ...
            from docu_chat.ui.ui import PrivateGptUi
